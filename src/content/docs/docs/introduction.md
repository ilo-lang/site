...
**ilo** is a token-optimised programming language for AI agents. Named from [Toki Pona](https://en.wikipedia.org/wiki/Toki_Pona) for ["tool"](https://sona.pona.la/wiki/ilo), it's designed to minimise the total token cost when AI agents write and run programs.
